...
MODEL_DEFAULTS: dict[str, dict[str, int | float | bool | str | None]] = {
    ...
    "fibo-edit": {"steps": 50, "guidance": 3.5, "quantize": 8, "scheduler": "flow_match_euler_discrete", "supports_negative_prompt": True},
    "fibo-edit-rmbg": {"steps": 10, "guidance": 1.0, "quantize": 8, "scheduler": "flow_match_euler_discrete", "supports_negative_prompt": False},
