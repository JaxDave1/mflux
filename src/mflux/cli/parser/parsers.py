...
class CommandLineParser(argparse.ArgumentParser):
    ...
    def add_save_depth_arguments(self) -> None:
        ...
        self.add_argument("--output", type=Path, default=None, required=False, help="Destination path for the depth map PNG. Default is <image-path-stem>_depth.png beside the source image.")
